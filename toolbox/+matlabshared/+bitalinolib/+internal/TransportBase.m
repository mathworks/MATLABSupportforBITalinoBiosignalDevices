        ...
        function decodedData = decodeFrames(~, data)
            ...
            for idx = 1:size(data, 1)
                ...
                if numAnalogChannels > 2
                    channels(3) = bitand(bitshift(uint16(biosignal(end-4)) +...
                        bitshift(uint16(biosignal(end-3)), BitalinoConstants.ShiftToUpperByte),...
                ...
                if numAnalogChannels > 3
                    channels(4) = bitand(bitshift(uint16(biosignal(end-5)) +...
